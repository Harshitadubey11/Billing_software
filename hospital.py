...
class Hospital:
    def __init__(self,root):
            ...
            self.DriveingUsingMachine = StringVar() 
...
# ======================================================COMBO-BOX==============================================================
            comNametablet=ttk.Combobox(DataframeLeft,textvariable=self.Nameoftablets,state="readonly",font=("times of roman",12,"bold"),width=33)
        ...
        # ===============================================================================================
            ...
            txtBloodPressure=Entry(DataframeLeft,font=("ariel",12,"bold"),textvariable=self.DriveingUsingMachine,width=35)
...
# ==================================================Buttons================================================================
            ...
            btnDelete=Button(Buttonframe,command=self.idelete,text="Delete",bg="green",fg="white",font=("arial",12,"bold"),width=24,padx=2,pady=6)
            ...
            btnExit=Button(Buttonframe,command=self.iExit,text="Exit",bg="green",fg="white",font=("arial",12,"bold"),width=24,padx=2,pady=6)
...
# ==================================================================Functionality Declaration====================================================
    def iPrescriptionData(self):
        ...
        if self.Nameoftablets.get()==''or self.ref.get()=='':
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="9575",database="hospi_data")
    ...
    def update_data(self):
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="9575",database="hospi_data")
        my_cursor=conn.cursor()
        my_cursor.execute("update hospital set Nameoftablets=%s,Reference_No=%s,dose=%s,Numbersoftablets=%s,lot=%s,issuedate=%s,expdate=%s,dailydose=%s,storage=%s,nhsnumber=%s,patientname=%s,DOB=%s,patientaddress=%s where Reference_No=%s",
                                                                                                (
                                                                                                        self.Nameoftablets.get(),
                                                                                                        self.Dose.get(),
                                                                                                        self.NumberofTablets.get(),
    ...
    def get_cursor(self,event=''):
        ...
        self.StorageAdvice.set(row[8])
                # self.DriveingUsingMachine.set(row[11]) 
    ...
    def iPrescription(self):
        ...
        self.txtPrescription.insert(END,"Dose: \t\t\t"+self.NumberofTablets.get()+"\n")
        ...
        self.txtPrescription.insert(END,"DrivingUsingMachine: \t\t\t"+self.DriveingUsingMachine.get()+"\n")
